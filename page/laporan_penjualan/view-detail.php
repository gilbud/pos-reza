<div class="row clearfix">
    <h1 class="mt-4">Detail Laporan Penjualan</h1>
    <p></p>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            $sql=$koneksi->query("SELECT pd.*, brg.* FROM tb_penjualan_detail pd JOIN tb_barang brg ON pd.kode_barcode = brg.kode_barcode WHERE pd.kode_penjualan ='$kode'");
                            ...
                            while ($data = $sql->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "Rp. ".number_format ($data['profit']*$data['jumlah'])?></td>

                                    
                                </tr>
                                <?php 
                                $total = $total+($data['profit']*$data['jumlah']);
                            } ?>
                        </tbody>
                        <tr>
